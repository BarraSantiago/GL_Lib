...
Cube::Cube(Transform transform, Material* material) : Entity(transform), material(material), ownsMaterial(false)
{
...
void Cube::setMaterial(Material* newMaterial, bool takeOwnership)
{
